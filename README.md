...
- Route helper methods help clean up the view and controller code and assist with readability. _On a side note, you cannot use these helper methods in your model files_.
